...
# Parámetros
#######################################################################################
nombreCategoria = "ESO-MAT-2.1-MAC-2.1-notacion cientifica solo grandes"
...
def generaEjercicioTipo2(parametros):
    ...
    return [corrigeAcentos(enunciado),respuestaCorrecta,distractor1,distractor2,distractor3]
...
for koko in range(numeroEjercicios):
    ...
    fLaTeX.write(r"" + "\n")    
    fLaTeX.write(r"" + cadenas[0] + "\n")
    fLaTeX.write(r"" + "\n")
    fLaTeX.write(r"    \item* " + str(cadenas[1]) + "\n") # El segundo elemento es la respuesta correcta.
    fLaTeX.write(r"    \item " + str(cadenas[2]) + "\n") # El resto de elementos son los distractores.
    fLaTeX.write(r"    \item " + str(cadenas[3]) + "\n")
    fLaTeX.write(r"    \item " + str(cadenas[4]) + "\n")
